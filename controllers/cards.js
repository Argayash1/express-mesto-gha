...
// Добрый день! Спасибо Вам большое за очень ценные советы по поводу удаления первого промиса и
// использования метода populate! Извините, пожалуйста, не стал переносить проверку на наличие
// карточки в then метода findByIdAndUpdate и удалять промис, так как мне хотелось бы использовать
// метод populate, поскольку в оригинале бэкенда проекта "Место" при постановке лайка приходит
